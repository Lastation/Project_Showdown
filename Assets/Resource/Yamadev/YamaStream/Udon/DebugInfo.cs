...
namespace Yamadev.YamaStream
{
    ...
    public class DebugInfo : Listener
    {
        ...
        void Update()
        {
            ...
            if (_videoOffsetText != null) _videoOffsetText.text = _sync.VideoStandardDelay.ToString();
        }
        ...
        public override void OnUrlChanged() => AddLog($"[{_controller.VideoPlayerType}] Play track: {_controller.Track.GetUrl()}.", true);
