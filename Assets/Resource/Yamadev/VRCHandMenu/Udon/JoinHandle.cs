    ...
    public class JoinHandle : UdonSharpBehaviour
    {
        ...
        public void UpdateView()
        {
            ...
            for (var i = start; i < joinLogs.Length; i++)
            {
                ...
                var hourStr = hourSpan != 0 ? $"{hourSpan}{mainSystem.s_Hour}" : "";
                var minuteStr = $"{minuteSpan}{mainSystem.s_Minute}";
                ...
                if (extraText) extraText.text = $"({hourStr}{minuteStr}{mainSystem.s_Before})";
